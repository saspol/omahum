...
Приложение скачивается тут:
https://github.com/2dust/v2rayNG/releases/download/1.6.30/v2rayNG_1.6.30_arm64-v8a.apk


## Настройка
Сначала копируем в буфер полученный ключ доступа, который выглядит примерно так:
...
Для подключения жмём на кнопку справа внизу, должно быть написано Connected (подключено).
